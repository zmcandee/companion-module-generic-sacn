...
rootLayer.prototype.setCID = function(id) {
	var self = this;
	
	id.copy(self.buf,0,22,38);
};

rootLayer.prototype.getCID = function() {
	var self = this;
	var tmpbuf = new Buffer(16);
	self.buf.slice(22,37).copy(tmpbuf);
	return tmpbuf;
};
